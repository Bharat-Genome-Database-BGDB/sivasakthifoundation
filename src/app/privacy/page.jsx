      ...
      <main className="container py-xl">
        ...
        <article className="flex flex-col gap-lg">
          ...
          <section className="card p-xl">
            <h2 className="card-title text-2xl">1. Terms of Use</h2>
          ...
          <section className="card p-xl">
            <h2 className="card-title text-2xl">2. Privacy Policy & Data Collection</h2>
          ...
          <section className="card p-xl">
            <h2 className="card-title text-2xl">3. Intellectual Property Rights</h2>
            <p className="card-body">
